...
export const PromotionalBannerSection = (): React.JSX.Element => {
  ...
  const products = [
    {
      image: "https://c.animaapp.com/mdh9p58vtKPJ88/img/mask-group-6.png",
      tag: "#ShahiAdaayein",
      title: "Amra Embroidery - Sharara Suits",
      color: "Lemon Green & Sky Blue",
      price: "₹ 23,500",
    },
    {
      image: "https://c.animaapp.com/mdh9p58vtKPJ88/img/mask-group-7.png",
      tag: "#WeddingTrousseau",
      title: "Resham & Kardana Work - Garara Suits",
      color: "Off White",
      price: "₹ 36,500",
    },
    {
      image: "https://c.animaapp.com/mdh9p58vtKPJ88/img/mask-group-8.png",
      tag: "#Royalty",
      title: "Matka Silk - Sharara Suits",
      color: "Ivory",
      price: "₹ 44,500",
    },
  ];
              ...
              <CardContent className="flex flex-col items-start gap-4 md:gap-[22.67px] p-4 md:p-[22.67px]">
                ...
                <div className="flex flex-col items-start gap-3 md:gap-[15.11px] w-full">
                  ...
                  <div className="flex flex-col items-start gap-2 md:gap-[10.58px] w-full">
                    ...
                    <div className="flex flex-col md:flex-row flex-wrap items-start gap-2 md:gap-[15.11px]">
                      <div className="flex items-center gap-2 md:gap-[6.05px]">
                        <span className="font-normal text-grey-50 text-xs md:text-[13.6px] leading-[15px] md:leading-[20.4px]">
                          Color
                        </span>
